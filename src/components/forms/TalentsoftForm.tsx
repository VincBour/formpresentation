...
import { Form, schemaValidator, SubmitButton, SubmitHandler, TextField } from "@talentsoft/forms";
...
export const TalentsoftForm = () => {
  ...
  return (
    <Layout>
      ...
      >
          <TextField name="name" label="Name" required fullWidth placeholder='test'/>
          <TextField name="email" label="e-mail" required fullWidth/>
          <TextField name="message" label="Message" rows={4} rowsMax={6} fullWidth multiline/>
